...
def test_todays_game():
    ...
    fcm_tokens = User.get_friends_fcm(user_id)
...
def get_todays_games():
    ...
    todays_games = TodaysGames.get_friends_today_games_by_user_id(user_id)
    my_todays_games = TodaysGames.get_my_today_games(user_id)
